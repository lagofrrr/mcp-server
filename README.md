...
## 💾 How to Download and Install mcp-server on Windows
...
3. **Download the Windows Installer**  
   In the Releases page, look for a file that ends with `.exe` – this is the installer for Windows. The file might be named something like `mcp-server-setup.exe`.  
...
5. **Follow the Setup Guide**  
   The installer will open a setup window. Follow these prompts:
